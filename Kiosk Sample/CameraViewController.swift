...
public class CameraViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    open func configureOutputs() {
        ...
        let pixelFormats = self.videoDataOutput.availableVideoPixelFormatTypes
        ...
        self.captureSessionQueue.async { [weak self] in
            ...
            if !self.captureSession.isRunning {
                DispatchQueue.main.async { [weak self] in
                    ...
                    let alertController = UIAlertController(title: nil, message: "Unable to resume", preferredStyle: .alert)
